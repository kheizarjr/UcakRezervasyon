...
namespace UcakRezervasyon.Controllers
{
    public class guzergahsController : Controller
    {
        ...
        {
            var guzergahlar = await _context.guzergah
                                .Select(g => new GuzergahViewModel
                                {
                                    GuzergahId = g.guzergahId,
                                    GuzergahName = g.guzergahName,
                                    UcusSayisi = _context.ucus.Count(u => u.guzergahId == g.guzergahId)
                                })
                                .ToListAsync();
